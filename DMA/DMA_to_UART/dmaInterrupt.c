/**
  *****************************************************************************
  * @title   stm32l1xx_it.c
  * @author  CooCox
  * @date    30 Dec 2013
  * @brief   This example provides a description of how to use a DMA channel
  *          to transfer a word data buffer from FLASH memory to embedded SRA
  *          M memory.
  *******************************************************************************
  */
...
extern __IO uint32_t xmitEndOfTransfer;
extern __IO uint32_t recvEndOfTransfer;
